...
[![Build Status](https://travis-ci.org/girishchawla/redoc.svg?branch=master)](https://travis-ci.org/girishchawla/redoc)
...
6. If you did everything correct, https://girishchawla.github.io/redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://girishchawla.github.io/redoc/
- SwaggerUI: https://girishchawla.github.io/redoc/swagger-ui/
- Look full spec:
    + JSON https://girishchawla.github.io/redoc/swagger.json
    + YAML https://girishchawla.github.io/redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://girishchawla.github.io/redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://girishchawla.github.io/redoc/ with url from the message: `Server started <url>`
